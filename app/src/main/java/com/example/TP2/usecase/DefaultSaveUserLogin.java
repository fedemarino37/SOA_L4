...
public class DefaultSaveUserLogin implements SaveUserLogin {
    private final SQLUserRepository sql;

    public DefaultSaveUserLogin() {
        this.sql = new DefaultSQLUserRepository();
    }
